...
#SBATCH --nodes=16
#SBATCH --job-name=tiny-base-prerelease-greylock-swift-v2-scatter-phase1_mix_0820_v6-pack-4ep-4acc-granite_fusion-5e-5-65536
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/tiny-base-prerelease-greylock-swift-v2-scatter-phase1_mix_0820_v6-pack-4ep-4acc-granite_fusion-5e-5-65536-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/tiny-base-prerelease-greylock-swift-v2-scatter-phase1_mix_0820_v6-pack-4ep-4acc-granite_fusion-5e-5-65536-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/bathen/models/base/granite-4.0-tiny-base-prerelease-greylock-hf-final \
    --train_type full \
    --dataset /mnt/vast/proj/datasets/sft-datasets/jsonl/preview_mix/granite-4.0-sft-datasets-0820/phase1_mix_0820_v6.jsonl \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/tiny-base-prerelease-greylock-swift-v2-ctv1-phase1_mix_0820_v6-pack-4ep-4acc-granite_fusion-5e-5-65536 \
    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/tiny-base-prerelease-greylock-swift-v2-ctv1-phase1_mix_0820_v6-pack-4ep-4acc-granite_fusion-5e-5-65536/v1-20250822-072129/checkpoint-7500 \

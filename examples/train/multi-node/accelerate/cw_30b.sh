...
#SBATCH --nodes=32
#SBATCH --job-name=30b-lc-128k-2-swift-v2-cvt1-phase1_mix_0812_v2-pack-4ep-4acc-loss_scale-5e-5-32768
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/30b-lc-128k-2-swift-v2-cvt1-phase1_mix_0812_v2-pack-4ep-4acc-loss_scale-5e-5-32768-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/30b-lc-128k-2-swift-v2-cvt1-phase1_mix_0812_v2-pack-4ep-4acc-loss_scale-5e-5-32768-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/lc-ckpts/30b-lc-128k-2/hf \
    --train_type full \
    --dataset /mnt/vast/proj/datasets/sft-datasets/jsonl/preview_mix/granite-4.0-sft-datasets-0812/phase1_mix_0812_v2.jsonl \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/30b-lc-128k-2-swift-v2-cvt1-phase1_mix_0812_v2-pack-4ep-4acc-loss_scale-5e-5-32768 \

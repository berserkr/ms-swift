...
#SBATCH --nodes=32
#SBATCH --job-name=granite-4.0-3b-base-prerelease-killington-final-phase1_mix_0830_v1-pack-3ep-4acc-granite_fusion-9e-5-32768-hybridclass
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-3b-base-prerelease-killington-final-phase1_mix_0830_v1-pack-3ep-4acc-granite_fusion-9e-5-32768-hybridclass-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-3b-base-prerelease-killington-final-phase1_mix_0830_v1-pack-3ep-4acc-granite_fusion-9e-5-32768-hybridclass-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/bathen/models/base/granite-4.0-3b-base-prerelease-killington-final-hybridclass \
    --train_type full \
    --dataset /mnt/vast/proj/datasets/sft-datasets/jsonl/preview_mix/granite-4.0-sft-datasets-0830/phase1_mix_0830_v1.jsonl \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-3b-base-prerelease-killington-final-phase1_mix_0830_v1-pack-3ep-4acc-granite_fusion-9e-5-32768-hybridclass \
    --attn_impl flash_attn \
    --use_chat_template true \
    --loss_scale granite_fusion \
    --use_liger_kernel true \
    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-3b-base-prerelease-killington-final-phase1_mix_0830_v1-pack-3ep-4acc-granite_fusion-9e-5-32768-hybridclass/v0-20250903-232412/checkpoint-4100 \

    "
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-3b-base-prerelease-killington-final-phase1_mix_0830_v1-pack-3ep-4acc-granite_fusion-9e-5-32768-hybridclass/v0-20250902-013937/checkpoint-8100
#    --use_liger_kernel true \
#    --gradient_checkpointing false \
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-3b-base-prerelease-killington-final-phase1_mix_0830_v1-pack-3ep-2acc-granite_fusion-9e-5-32768-hybridclass-dbg/v0-20250828-224635/checkpoint-7900 \

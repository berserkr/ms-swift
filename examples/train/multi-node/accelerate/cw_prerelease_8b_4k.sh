...
#SBATCH --nodes=16
#SBATCH --job-name=8b-soft-p4-phase1_mix_1006_102225_v2-pack-3ep-4acc-granite-1e-5-4096-swift_v3_2.0scale
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/8b-soft-p4-phase1_mix_1006_102225_v2-pack-3ep-4acc-granite-1e-5-4096-swift_v3_2.0scale-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/8b-soft-p4-phase1_mix_1006_102225_v2-pack-3ep-4acc-granite-1e-5-4096-swift_v3_2.0scale-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/8b-soft-p4/hf \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/8b-soft-p4-phase1_mix_1006_102225_v2-pack-3ep-4acc-granite-1e-5-4096-swift_v3_2.0scale \

...
#SBATCH --nodes=16
#SBATCH --job-name=granite-4.0-tiny-base-prerelease-greylock-final-phase1_mix_0830_v5-pack-3ep-4acc-granite-5e-5-65536-swift_v3-aux
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-tiny-base-prerelease-greylock-final-phase1_mix_0830_v5-pack-3ep-4acc-granite-5e-5-65536-swift_v3-aux-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-tiny-base-prerelease-greylock-final-phase1_mix_0830_v5-pack-3ep-4acc-granite-5e-5-65536-swift_v3-aux-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/bathen/models/base/granite-4.0-tiny-base-prerelease-greylock-hf-final \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-tiny-base-prerelease-greylock-final-phase1_mix_0830_v5-pack-3ep-4acc-granite-5e-5-65536-swift_v3-aux \
    --attn_impl flash_attn \
    --use_chat_template true \
    --loss_scale granite \
    --router_aux_loss_coef 1e-3 \
    "
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-tiny-base-prerelease-greylock-final-phase1_mix_0830_v5-pack-3ep-4acc-granite-5e-5-65536-swift_v3-aux/v0-20250830-042840/checkpoint-2500 \
#    --loss_scale granite \
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-tiny-base-prerelease-greylock-final-phase1_mix_0830_v5-pack-3ep-4acc-granite-5e-5-65536-swift_v3-aux/v1-20250831-062806/checkpoint-1300

...
#SBATCH --nodes=32
#SBATCH --job-name=granite-4.0-small-base-prerelease-greylock-final-phase1_mix_0825_v1-pack-3ep-4acc-granite_fusion-1e-5-32768
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-small-base-prerelease-greylock-final-phase1_mix_0825_v1-pack-3ep-4acc-granite_fusion-1e-5-32768-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-small-base-prerelease-greylock-final-phase1_mix_0825_v1-pack-3ep-4acc-granite_fusion-1e-5-32768-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/bathen/models/base/granite-4.0-small-base-prerelease-greylock-final \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-small-base-prerelease-greylock-final-phase1_mix_0825_v1-pack-3ep-4acc-granite_fusion-1e-5-32768 \
    --attn_impl flash_attn \
    --use_chat_template true \
    --loss_scale granite_fusion \
    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-small-base-prerelease-greylock-final-phase1_mix_0825_v1-pack-3ep-4acc-granite_fusion-1e-5-32768/v0-20250904-062016/checkpoint-2400 \
    
    "
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-small-base-prerelease-greylock-final-phase1_mix_0825_v1-pack-3ep-4acc-granite_fusion-1e-5-32768/v0-20250825-042840/checkpoint-2500 \
#    --loss_scale granite \
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-small-base-prerelease-greylock-final-phase1_mix_0825_v1-pack-3ep-4acc-granite_fusion-1e-5-32768/v0-20250828-191934/checkpoint-5000 \

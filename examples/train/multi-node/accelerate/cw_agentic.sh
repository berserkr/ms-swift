...
#SBATCH --nodes=16
#SBATCH --job-name=7b-p4-lc-128k-swift-ct-tools-16k
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/7b-p4-lc-128k-swift-ct-tools-16k-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/7b-p4-lc-128k-swift-ct-tools-16k-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/lc-ckpts/7b-p4-lc-128k/hf \
    --train_type full \
    --dataset /mnt/vast/proj/datasets/sft-datasets/jsonl/granite-4.0-sft-datasets-general-small/emoji_company_filtered/tools.messages.jsonl \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/7b-p4-lc-128k-swift-ct-tools-15k \

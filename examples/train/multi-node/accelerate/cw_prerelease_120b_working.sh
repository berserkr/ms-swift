...
#SBATCH --nodes=64
#SBATCH --job-name=lc-120b-lc-128k-p4-phase1_mix_0830_v5-pack-3ep-4acc-granite-9e-6-8192
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/lc-120b-lc-128k-p4-phase1_mix_0830_v5-pack-3ep-4acc-granite-9e-6-8192-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/lc-120b-lc-128k-p4-phase1_mix_0830_v5-pack-3ep-4acc-granite-9e-6-8192-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/lc-ckpts/120b-lc-128k-p4/hf \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/lc-120b-lc-128k-p4-phase1_mix_0830_v5-pack-3ep-4acc-granite-9e-6-8192 \
    ...
    "
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/lc-120b-lc-128k-p4-phase1_mix_0830_v5-pack-3ep-4acc-granite-9e-6-8192/v0-20250830-042840/checkpoint-2500 \
#    --loss_scale granite \
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/lc-120b-lc-128k-p4-phase1_mix_0830_v5-pack-3ep-4acc-granite-9e-6-8192/v0-20250828-191934/checkpoint-5000 \

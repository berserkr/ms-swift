...
#SBATCH --nodes=16
#SBATCH --job-name=7b-p4-lc-128k-swift-ot-ct
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/7b-p4-lc-128k-swift-ot-ct-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/7b-p4-lc-128k-swift-ot-ct-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/edited/7b-p4-lc-128k \
    --train_type full \
    --dataset /mnt/vast/proj/datasets/sft-datasets/os/OpenThoughts3-1.2M \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/7b-p4-lc-128k-swift-ot-ct \
    --attn_impl flash_attn \
    --use_chat_template ${CHAT_TEMPLATE_PATH} \

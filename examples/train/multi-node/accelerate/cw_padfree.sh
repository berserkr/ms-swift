...
#SBATCH --nodes=16
#SBATCH --job-name=7b-p4-lc-128k-swift-hermes_mix_pf-5ep-16k
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/7b-p4-lc-128k-swift-hermes_mix_pf-5ep-16k-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/7b-p4-lc-128k-swift-hermes_mix_pf-5ep-16k-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/lc-ckpts/7b-p4-lc-128k/hf \
    --train_type full \
    --dataset /mnt/vast/proj/datasets/sft-datasets/jsonl/mixes/ash_mix/hermes_mix.jsonl\
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/7b-p4-lc-128k-swift-hermes_mix_pf-16k-5ep \

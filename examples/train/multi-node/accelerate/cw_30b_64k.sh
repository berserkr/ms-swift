...
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/30b-lc-128k-2-swift-v2-ctv1-phase1_mix_0820_v4-pack-4ep-4acc-granite_fusion-5e-5-65536-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/30b-lc-128k-2-swift-v2-ctv1-phase1_mix_0820_v4-pack-4ep-4acc-granite_fusion-5e-5-65536-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/lc-ckpts/30b-lc-128k-2/hf \
    --train_type full \
    --dataset /mnt/vast/proj/datasets/sft-datasets/jsonl/preview_mix/granite-4.0-sft-datasets-0820/phase1_mix_0820_v4.jsonl \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/30b-lc-128k-2-swift-v2-ctv1-phase1_mix_0820_v4-pack-4ep-4acc-granite_fusion-5e-5-65536 \

...
#SBATCH --nodes=32
#SBATCH --job-name=30b-p2-swift-v2-phase2_thinking_v2_mix_0812-pack-3ep-4acc-granite_fusion-5e-5-32768
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/30b-p2-swift-v2-phase2_thinking_v2_mix_0812-pack-3ep-4acc-granite_fusion-5e-5-32768-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/30b-p2-swift-v2-phase2_thinking_v2_mix_0812-pack-3ep-4acc-granite_fusion-5e-5-32768-err.%j.log" 
...
OUTPUT_MODEL_PATH=/mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/30b-p2-swift-v2-phase2_thinking_v2_mix_0812-pack-3ep-4acc-granite_fusion-5e-5-32768
DATA_MIX_PATH=/mnt/vast/proj/datasets/sft-datasets/jsonl/preview_mix/granite-4.0-sft-datasets-0812/phase2_thinking_v2_mix_0812.jsonl
...
export SCRIPT_ARGS="--model ${MODEL_BASE_PATH} \
    ...
    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/30b-p2-swift-v2-phase2_thinking_v2_mix_0812-pack-3ep-4acc-granite_fusion-5e-5-32768/v1-20250813-204123/checkpoint-400 \
    "

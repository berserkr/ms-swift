...
#SBATCH --nodes=32
#SBATCH --job-name=granite-4.0-8b-base-prerelease-killington-final-phase1_mix_1006_102225_v1-pack-3ep-8acc-granite-5e-5-16384-swift_v3_2.0scale_pf_bs1
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-8b-base-prerelease-killington-final-phase1_mix_1006_102225_v1-pack-3ep-8acc-granite-5e-5-16384-swift_v3_2.0scale_pf_bs1-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-8b-base-prerelease-killington-final-phase1_mix_1006_102225_v1-pack-3ep-8acc-granite-5e-5-16384-swift_v3_2.0scale_pf_bs1-err.%j.log" 
...
export SCRIPT_ARGS="--model /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/granite-4.0-8b-base-prerelease-killington-final \
    ...
    --output_dir /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-8b-base-prerelease-killington-final-phase1_mix_1006_102225_v1-pack-3ep-8acc-granite-5e-5-16384-swift_v3_2.0scale_pf_bs1 \
    --attn_impl flash_attn \
    --use_chat_template true \
    --loss_scale granite \
    "

#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-8b-base-prerelease-killington-final-phase1_mix_1006_102225_v1-pack-3ep-8acc-granite-5e-5-16384-swift_v3_2.0scale_pf_bs1/v0-20251023-072716/checkpoint-1700 \    
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-8b-base-prerelease-killington-final-phase1_mix_1006_102225_v1-pack-3ep-8acc-granite-5e-5-16384-swift_v3_2.0scale_pf_bs1/v0-20250830-042840/checkpoint-2500 \
#    --loss_scale granite \
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-8b-base-prerelease-killington-final-phase1_mix_1006_102225_v1-pack-3ep-8acc-granite-5e-5-16384-swift_v3_2.0scale_pf_bs1/v1-20250831-062806/checkpoint-1300

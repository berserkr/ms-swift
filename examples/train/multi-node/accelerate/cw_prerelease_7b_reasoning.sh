...
#SBATCH --nodes=16
#SBATCH --job-name=granite-4.0-tiny-sft-phase1_mix_0914_v2-pack-3ep-4acc-granite-1e-5-65536-swift_v3
#SBATCH --ntasks-per-node=1  #<--must be 1 for torchrun / override for others like mpi
#SBATCH --gpus-per-node=4
#SBATCH --cpus-per-task=144 
#SBATCH --output="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-tiny-sft-phase1_mix_0914_v2-pack-3ep-4acc-granite-1e-5-65536-swift_v3-out.%j.log" 
#SBATCH --error="/mnt/vast/proj/checkpoints/bathen/logs/granite-4.0-tiny-sft-phase1_mix_0914_v2-pack-3ep-4acc-granite-1e-5-65536-swift_v3-err.%j.log" 
...
DATASET=/mnt/vast/proj/datasets/sft-datasets/jsonl/preview_mix/granite-4.0-sft-datasets-0914/phase1_mix_0914_v2.jsonl
MODEL=/mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-tiny-base-prerelease-greylock-final-phase1_mix_0830_v5-pack-3ep-4acc-granite-5e-5-65536/v0-20250906-062230/checkpoint-780
OUTPUT=/mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-tiny-sft-phase1_mix_0914_v2-pack-3ep-4acc-granite-1e-5-65536-swift_v3

export MODELSCOPE_CACHE=/mnt/vast/proj/checkpoints/bathen/cache 
export SCRIPT_ARGS="--model ${MODEL} \
    --train_type full \
    --dataset ${DATASET} \
...
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-tiny-sft-phase1_mix_0914_v2-pack-3ep-4acc-granite-1e-5-65536-swift_v3/v0-20250830-042840/checkpoint-2500 \
#    --loss_scale granite \
#    --resume_from_checkpoint /mnt/vast/proj/checkpoints/granite-4-models-carina/ckpts/sft/granite-4.0-tiny-sft-phase1_mix_0914_v2-pack-3ep-4acc-granite-1e-5-65536-swift_v3/v1-20250831-062806/checkpoint-1300
